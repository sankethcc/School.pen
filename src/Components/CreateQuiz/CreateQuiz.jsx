...
const CreateQuiz = ({handleOpenPage,openPageName, openPage, handleOpenPageNameUpdate}) => {
    ...
    const propsForLanguageDotMenu = {handleThreeDotMenu, handleOpenPageNameUpdate} 
    const propsForProfileRow = {openPageName, handleOpenPage, handleOpenPageNameUpdate}
  return (
    <Box 
    style={style.dflex} 
    sx={{
        ...
        <Box sx={{
            ...
            <ProfileWrapper {...propsForProfileRow} />
                ...
                <AssignUser /> 
            :(openPage == "User Profile")?<UserProfile />
            :
            <Box>
